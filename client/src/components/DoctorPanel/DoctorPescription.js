...
import pesimg from './profileuser.png'
import confirmation from './confirmation.png'
import addd from './adding.svg'
...
function Pescription() {
    return (
        ...
        <div className="DPescription_1strow">
            ...
            <div className="pescriptionid">
                 ID : Cx45Sa123
            </div>
        </div>
        <div className="DPescription_2ndrow">
            <button style={{backgroundColor:'#3016CF'}}>Add Resused Meicines</button>
            <button style={{backgroundColor:'#CF4216'}}>Prescribe</button>
            <div className="DPdropdownbox">
                <div>Prescription Expires on</div>
                <div>
                <select name="day">
...
<select id="year">
    ...
    <option >{year+3}</option>
        ...
        <div className="DPescription_3rdrow">
            <div className="DpMedList">
               <input placeholder="Medicine"></input> 
               <select id="Frequency">
                  <option value="01">1</option>
                  <option value="02">2</option>
                  <option value="03">3</option>
